      ...
      <div className="mt-5 space-y-4">
        <div>
          ...
          <p className="mt-2 text-sm leading-relaxed text-zinc-300">
            {fact?.ruleSummary ?? "No rule context available yet. Telemetry analysis is still in progress."}
          </p>
        </div>
        <div>
          <p className="text-[11px] uppercase tracking-[0.18em] text-zinc-500">AI Ruling Draft</p>
          <p className="mt-2 text-sm leading-relaxed text-zinc-200">{fact?.ruling ?? "Pending"}</p>
        </div>
      </div>
    </aside>
  );
